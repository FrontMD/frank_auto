function brandsList() {
    ...
    const showMoreLayout = `<span class="btn__text show">Все автомобили</span><span class="btn__text hide">Показать меньше</span>`
    ...
    function brandsListInit(brandsList) {
        ...
        const rows = brandsList.classList.contains('brands-list--full') ? 4 : 5
